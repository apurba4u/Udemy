...
import { Menu, X, Sun, Moon, Search, User, LogOut, ChevronDown } from 'lucide-react';
      ...
      <Container>
        <div className="flex h-16 items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <button className="rounded-lg p-2 text-neutral-600 hover:bg-neutral-100 dark:text-neutral-400 dark:hover:bg-neutral-800">
